# Samsung Switch Watch 0.4.1-poc
...
- 실제 Immutable Releases 설정과 `v*` 태그 변경·삭제 ruleset
- 정확한 태그·커밋 재검증, draft 서버 digest 대조, 게시 전 build provenance와 게시 후
  release attestation으로 6개 자산 검증
