...
```powershell
.\scripts\build-release.ps1 -Version 0.9.0-poc -AllowDirty
```
...
```powershell
git tag -a v0.9.0-poc -m "Samsung Switch Watch v0.9.0-poc"
git push origin v0.9.0-poc
```
