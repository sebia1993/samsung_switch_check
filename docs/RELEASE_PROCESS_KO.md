...
```powershell
.\scripts\build-release.ps1 -Version 0.9.9-poc
```
...
```powershell
.\scripts\build-release.ps1 -Version 0.9.9-poc -AllowDirty
```
...
```powershell
git tag -a v0.9.9-poc -m "Samsung Switch Watch v0.9.9-poc"
git push origin v0.9.9-poc
```
