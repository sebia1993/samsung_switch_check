...
internal static class ViewerConnectionMessages
{
    ...
    public static string ForCode(string? errorCode) => errorCode switch
    {
        ...
        "AGENT_CONNECTION_REFUSED" => "연결이 거부되었습니다. 입력한 주소가 스위치나 Viewer PC가 아니라 Agent를 설치한 PC의 주소인지 먼저 확인하고, SamsungSwitchWatchAgent 서비스와 TCP/18443 수신 상태를 확인해 주세요.",
        ...
        "VIEWER_MONITOR_STATE_VERSION_UNSUPPORTED" => "감시 이력 파일이 현재 Viewer보다 새로운 형식입니다. 파일을 변경하지 않았으며 같거나 최신 버전의 Viewer를 사용해 주세요.",
        "VIEWER_MONITOR_STATE_UNAVAILABLE" => "Viewer 감시 이력 파일을 읽거나 격리할 수 없어 자동 감시를 시작하지 않았습니다. 사용자 폴더 권한과 파일 잠금을 확인해 주세요.",
        ...
        "VIEWER_DEVICE_STORE_CORRUPT" => "장비 설정 파일이 손상되어 원본을 보존하고 이번 실행의 자동 감시를 시작하지 않았습니다. 격리된 파일을 확인하고 장비를 다시 등록해 주세요.",
        "VIEWER_DEVICE_STORE_VERSION_UNSUPPORTED" => "장비 설정 파일이 현재 Viewer보다 새로운 형식입니다. 원본을 변경하지 않고 이번 실행의 자동 감시를 시작하지 않았습니다. 같거나 최신 버전의 Viewer를 사용해 주세요.",
        "VIEWER_DEVICE_STORE_UNAVAILABLE" => "장비 설정 파일을 읽거나 Windows 사용자 자격 증명으로 보호할 수 없어 원본을 변경하지 않고 이번 실행의 자동 감시를 시작하지 않았습니다. 사용자 폴더 권한, 파일 잠금과 Windows 사용자 프로필을 확인해 주세요.",
        "VIEWER_DEVICE_STORE_WRITE_FAILED" => "장비 설정을 저장하지 못했습니다. 사용자 폴더 권한, 파일 잠금과 디스크 여유 공간을 확인해 주세요.",
        "LOCAL_PRIVATE_IPV4_NOT_FOUND" => "이 PC에서 사용할 사설 IPv4를 찾지 못했습니다. 유선 또는 관리망 어댑터가 연결되어 있는지 확인해 주세요.",
        "LOCAL_PRIVATE_IPV4_DISCOVERY_FAILED" => "이 PC의 네트워크 주소를 확인하지 못했습니다. 네트워크 어댑터 상태를 확인한 뒤 다시 시도해 주세요.",
        "LOCAL_AGENT_PREFLIGHT_FAILED" => "이 PC에서 Agent를 찾지 못했습니다. SamsungSwitchWatchAgent 서비스가 실행 중인지 확인하고 Viewer의 Agent PC 주소에 127.0.0.1 또는 이 PC의 사설 IPv4를 입력해 다시 연결해 주세요.",
        "LOCAL_AGENT_PREFLIGHT_TIMEOUT" => "동일 PC 사전 테스트가 안전 제한 시간 안에 끝나지 않았습니다. Agent 서비스와 사용 중인 관리망 어댑터를 확인한 뒤 다시 시도해 주세요.",
