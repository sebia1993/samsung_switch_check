...
internal static class ViewerConnectionMessages
{
    public static string ForCode(string? errorCode) => errorCode switch
    {
        ...
        "VIEWER_DEVICE_STORE_CORRUPT" => "장비 설정 파일이 손상되었습니다. 격리된 파일을 확인하고 장비를 다시 등록해 주세요.",
        "VIEWER_DEVICE_STORE_UNAVAILABLE" => "장비 설정 파일을 읽을 수 없습니다. 사용자 폴더 권한과 파일 잠금을 확인해 주세요.",
